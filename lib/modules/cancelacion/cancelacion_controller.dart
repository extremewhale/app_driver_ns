...
class CancelacionController extends GetxController {
  late ScrollController scrollController;
  final gbAppbar = 'gbAppbar';

  late CancelacionController _self;
  ...
  Future<void> _init() async {
    if (!(Get.arguments is CancelacionArguments)) {
      Helpers.showError('Falta pasar los argumentos');
      return;
    }

    final arguments = Get.arguments as CancelacionArguments;
