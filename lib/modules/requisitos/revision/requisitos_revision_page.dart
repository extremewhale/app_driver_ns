...
import 'package:app_driver_ns/modules/requisitos/revision/requisitos_revision_controller.dart';
...
class RequisitosRevisionPage extends StatelessWidget {
  final _conX = Get.put(RequisitosRevisionController());
              ...
              child: Column(
                ...
                children: [
                  ...
                  FadeInDown(
                    ...
                    from: 50,
                    child: AkText(
                      'Tu solicitud de registro está siendo evaluada por nuestro equipo. Te contactaremos vía SMS o correo electrónico con el resultado.',
